                ...
                if (holder.mMoviePoster.getDrawable() != null) {
                    ...
                    if (!MainActivity.mTwoPane) {
                        ...
                        if (limelightMovie.getPosterPath() != null) {
                            ...
                            byte[] byteArray = Utils.convertImageViewToByteArray(holder.mMoviePoster);
                        ...
                        // If movie data needs to be loaded in MovieFragment, pass the movie id as an extra.
                        if (mLimelightMovies != null) {
                            args.putParcelable(DetailActivity.PARCELABLE_MOVIE_EXTRA, limelightMovie);
                        } else {
                            args.putLong(Intent.EXTRA_TEXT, limelightMovie.getMovieId());
                        }
                        ...
                        if (limelightMovie.getPosterPath() != null) {
                            ...
                            // Pass this byte array into the bundle
                            args.putByteArray(Intent.EXTRA_STREAM, byteArray);
                        }
